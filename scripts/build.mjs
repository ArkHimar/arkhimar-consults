...
for(const entry of ['index.html','404.html','styles.css','app.js','robots.txt','sitemap.xml','site.webmanifest','favicon.svg','favicon-32.png','apple-touch-icon.png','assets','lib','resources','start-a-project','project-management','pm','share'])await cp(entry,`${output}/${entry}`,{recursive:true});
